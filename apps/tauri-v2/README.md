...
**Based on [Handy](https://github.com/cjpais/Handy) by cjpais**
...
- **Parakeet-First**: Optimized for CPU-based transcription using Parakeet models
- **Light Theme Option**: Choose between dark or light UI themes
